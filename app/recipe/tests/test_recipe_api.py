...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_recipe_with_existing_tags(self):
        ...
        payload = {
            ...
            'time_minutes': 60,
            'price': Decimal(50.50),
            'tags': [{'name': 'Kenyan'}, {'name': 'Breakfast'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 20,
            'price': Decimal('30.50'),
            'ingredients': [{'name': 'Netscafe'}, {'name': 'sugar'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        payload = {
            'title': 'Kalenjin Mursik',
            'time_minutes': 3000,
            'price': '300.50',
            'ingredients': [{'name': 'Milk'}, {'name': 'Suteek'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title='fried eggs')
    ...
    def test_filter_by_ingredients(self):
        ...
        r3 = create_recipe(user=self.user, title='Mango Juice')
